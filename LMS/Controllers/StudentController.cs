    ...
    public class StudentController : Controller
    {
        ...
        public IActionResult ClassListings(string subject, string num)
        {
              ...
              string category, string asgname, string uid, string contents)
            {
                ...
                if (existing != null)
                {
                    // replace contents and time, keep score
                    existing.SubmissionContents = contents;
            ...
            public IActionResult Enroll(string subject, int num, string season, int year, string uid)
            {
                ...
                bool already = db.Enrolleds.Any(e => e.Student == uid && e.Class == cls.ClassId);
                if (already)
                {
                    return Json(new { success = false });
                }

                var next = new Enrolled
                {
                    Student = uid,
                    Class = cls.ClassId,
                    Grade = "--"
        ...
        /// <summary>
        /// Converts the grade letter to points used to calculate GPA
        /// </summary>
        /// <param name="grade">Letter grade from DB</param>
        /// <returns>points value as double</returns>
